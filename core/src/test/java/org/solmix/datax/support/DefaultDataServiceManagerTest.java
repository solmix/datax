...
public class DefaultDataServiceManagerTest
{
    ...
    public void testLoading() {
        ...
        assertEquals(org.solmix.datax.service.TestDataService.class, dsi.getServiceClass());
        ...
        assertEquals(LookupType.CONTAINER, dsi.getLookup());
        assertEquals(org.solmix.datax.service.TestValidator.class, v.getClazz());
       ...
       assertEquals(org.solmix.datax.transformer.TestTransformer.class, ti.getClazz());
       ...
       assertEquals(org.solmix.datax.transformer.TestTransformer.class, vi.getClazz());

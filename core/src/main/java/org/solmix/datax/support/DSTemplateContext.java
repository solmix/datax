...
public class DSTemplateContext extends MappedTemplateContext {

	public DSTemplateContext(ToolkitService toolkit, DSRequest request) {
	...
	public DSTemplateContext(Container container, DSRequest request,DSResponse response) {

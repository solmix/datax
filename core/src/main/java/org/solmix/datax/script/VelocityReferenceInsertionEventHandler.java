 ...
 * @version 110046 
 */
public class VelocityReferenceInsertionEventHandler implements ReferenceInsertionEventHandler
{
    ...
    private static Logger log = LoggerFactory.getLogger(VelocityReferenceInsertionEventHandler.class.getName());
    ...
    public VelocityReferenceInsertionEventHandler(Context ctx)
    {
        this(ctx, null);
    }

    public VelocityReferenceInsertionEventHandler(Context ctx, DataService ds)
    {
        externals = new ArrayList<String>();
        this.escapeValues = ds == null ? false : true;
        this.ds = ds;
